...
function checkBurns(){
    if (localStorage.getItem("spot" + localStorage.getItem("selected")) == "shell"){
        localStorage.setItem("burned-shell", "true");
    }

    if (localStorage.getItem("spot" + localStorage.getItem("selected")) == "chalice" && localStorage.getItem("chalice-full") == "true"){
        localStorage.setItem("burned-cup", "true");
    }

    if (localStorage.getItem("spot" + localStorage.getItem("selected")) == "fish"){
        localStorage.setItem("burned-fish", "true");
    }

    if (localStorage.getItem("spot" + localStorage.getItem("selected")) == "water-totem"){
        localStorage.setItem("burned-totem", "true");
    }

    if (localStorage.getItem("burned-shell") == "true" && localStorage.getItem("burned-cup") == "true" && localStorage.getItem("burned-fish") == "true" && localStorage.getItem("burned-totem") == "true"){
        localStorage.setItem("appeased", "true");
        appease();
    }
}

function appease(){
    document.getElementsByClassName("eyes")[0].innerHTML = `<img draggable="false" class="main-art" src="temple-art/temple-off.gif" alt="">`;
}
