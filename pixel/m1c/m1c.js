...
function ready() {
    ...
    var ropeBut = document.getElementsByClassName("rope-but")[0];
    if (localStorage.getItem("has-rope") == "true") {
        take(ropeBut, "rope");
    } else {
        ropeBut.addEventListener('click', function tk() {
            ropeBut.removeEventListener('click', tk);
            take(ropeBut, "rope");
        });
    }
    ...
    if (localStorage.getItem("has-pickaxe") == "true" || localStorage.getItem("has-purple-pickaxe") == "true" || localStorage.getItem("has-red-pickaxe") == "true" || localStorage.getItem("has-green-pickaxe") == "true") {
        ...
        pickaxeBut.addEventListener('click', function tk() {
            pickaxeBut.removeEventListener('click', tk);
            take(pickaxeBut, "pickaxe");
        });
    }
}
